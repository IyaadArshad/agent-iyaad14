  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs text-gray-500">PDF, MD, or TXT (MAX. 10MB)</p>
              </div>
      ...
      <div className="mt-4 text-sm text-gray-500 text-center">
        <p>Your document will be analyzed and improved following BRS best practices.</p>
        <p className="mt-1">The improved document will appear in your library once processing is complete.</p>
      </div>
    </div>
  );
}
